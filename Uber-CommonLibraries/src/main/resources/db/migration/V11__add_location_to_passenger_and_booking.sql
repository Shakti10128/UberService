ALTER TABLE passenger
    ADD current_booking_id BIGINT NULL;
...
ALTER TABLE driver
    ADD is_driver_active BIT(1) NULL;

ALTER TABLE driver
    MODIFY is_driver_active BIT (1) NOT NULL;
...
ALTER TABLE passenger
    ADD CONSTRAINT FK_PASSENGER_ON_CURRENTBOOKING FOREIGN KEY (current_booking_id) REFERENCES booking (id);
